...
import com.august.algorithms.coursera.sorting.insertionsort.InsertionSortImpl;

// "static void main" must be defined in a public class.
public class ImprovedMergeSortImpl {
    public static void main(String[] args) {
        
        Integer[] a = {90, 30, 50, 40, 20, 60, 10, 80};
        ImprovedMergeSort.sort(a);
...
class ImprovedMergeSort {
    ...
    private static void sort(Comparable[] a, Comparable[] aux, int left, int right) {
        if (left + CUTOFF - 1 >= right) {
            InsertionSortImpl.sort(a, left, right);
            return;
        }
